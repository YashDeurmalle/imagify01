    ...
    try {
      ...
      if(state === "Login"){
        ...
        if(data.success){
          setToken(data.token)
          setUser(data.user)
          // console.log("User Data:", data.user.user);
  ...
  return (
    ...
    {state === 'Login' ?
        <p className="mt-5 text-center">
          ...
          <span className="cursor-pointer text-blue-600" onClick={() => setState("Sign Up")}>Sign up</span>
        </p>
        :
        <p className="mt-5 text-center">
          Already have an account!{" "}
          <span className="cursor-pointer text-blue-600" onClick={() => setState("Login")}>Login</span>
        </p>
    }
