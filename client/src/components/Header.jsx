...
const Header = () => {
  ...
  return (
    ...
    >
        ...
        >Upleash your creativity with AI. Turn imagination into visual art in seconds - just type, and watch the magic happen.</motion.p>
        ...
        >Generated images from PictoText</motion.p>
    </motion.div>
  )
}
